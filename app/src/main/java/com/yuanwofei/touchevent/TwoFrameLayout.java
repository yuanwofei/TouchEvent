...
public class TwoFrameLayout extends FrameLayout {
    ...
    public final static String TAG = "TwoFrameLayout";

    public TwoFrameLayout(Context context) {
        super(context);
    }

    public TwoFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TwoFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
